...
export default function Home() {
  const [array, setArray] = useState([<Block index={0} />]);
  return (
    <div className="flex  h-screen w-full justify-center mx-auto items-center ">
      <div className="flex flex-col w-1/2 justify-center items-center gap-11">
        ...
        <div className="h-[200px] w-[350px] shadow-xl drop-shadow-xl hover:shadow-2xl duration-200 rounded-lg p-11 flex flex-col items-center justify-between">
          <div
            style={{
              boxShadow: "0px 1px 20px 1px rgba(0,0,0,0.1)",
              transition: "box-shadow 0.15s ease-in-out",
            }}
            className="flex rounded-lg shadow-sm border-1 border-gray-400 "
          >
          ...
          <div className="">
            <button
              onClick={() =>
                setArray([...array, <Block index={array.length} />])
              }
              className=" w-[190px] h-12 rounded-full text-white flex justify-center items-center bg-gradient-to-r from-red-600 from-60% to-orange-500  "
            >
              + ADD NEW BLOCK
            </button>
          </div>
